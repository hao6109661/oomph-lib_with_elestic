...
plot file1 using 1:2 with lines linewidth 2.7 lc rgb "red" title "Beam with rotation and translation", \
     file1 using 10:11 with lines linewidth 2.7 lc rgb "yellow" title "Beam moves back"
     #file1 using (column(1)*cos(theta_eq)-column(2)*sin(theta_eq)+X0):(column(1)*sin(theta_eq)+column(2)*cos(theta_eq)+Y0) with lines linewidth 2.7 lc rgb "red" title "Beam with rotation and translation",\
     #file2 using 1:2 with lines linewidth 2.7 lc rgb "yellow" title "Beam with rotation and translation",\
